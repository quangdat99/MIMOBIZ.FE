          ...
          <div class="form-body">
            ...
            <div class="form-group">
              ...
              <div class="input-with-icon">
                <svg class="input-prefix-icon" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="submit-action">
              <button class="btn-login" @click="login" :disabled="isSubmitting">
                ...
                <svg class="btn-arrow" viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
